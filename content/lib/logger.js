...
Logger.SEV_LABEL.forEach(function(label, severity) {
    ...
    Logger.prototype[label.toLowerCase()] = function() {
        ...
        if(arguments[0] instanceof Error || label=="ERROR") {
            this.dispatchEvent("onError", [arguments[0]]);
        }
...
Logger.prototype.addListener = function(listener) {
    if(UTIL.has(this.listeners, listener)) return;
    this.listeners.push(listener);
}

Logger.prototype.dispatchEvent = function(name, args) {
